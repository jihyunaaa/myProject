...
public class OracleBoardComboLikedDAO { // 꿀조합 게시판 좋아요 기능 - Oracle DB
	...
	final String SELECTALL = "SELECT BOARD_COMBO_LIKED.BOARD_COMBO_LIKED_NUMBER, BOARD_COMBO_LIKED.BOARD_COMBO_NUMBER,"
