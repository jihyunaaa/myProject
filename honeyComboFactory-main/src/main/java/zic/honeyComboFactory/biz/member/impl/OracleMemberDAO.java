...
public class OracleMemberDAO { // 회원 기능 - Oracle DB
	private Connection conn;
	private PreparedStatement pstmt;

	// 1. 전체 회원 목록 조회
	final String SELECTALL = "SELECT MEMBER_NUMBER, MEMBER_ID, MEMBER_NAME, MEMBER_BIRTH, MEMBER_PHONE_NUMBER, MEMBER_ADDRESS_MAIN,"
