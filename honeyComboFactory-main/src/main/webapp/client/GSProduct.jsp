						...
						<div class="section-tittle mb-70 text-center">
							...
							<div class="search-box">
								<input id="searchKeyword" type="text"
									placeholder="GS25 상품을 검색해보세요!"> 
									<i class="fas fa-search" onclick="searchGSProductName()" style="cursor: pointer;"></i>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="section-tittle mb-70 text-center">
							...
							<div class="search-box">
								<input id="searchStoreKeyword" type="text"
									placeholder="주변에 GS25가 있는지 검색해보세요!">
